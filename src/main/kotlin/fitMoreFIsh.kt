fun main(args: Array<String>) {
    ...
    println("Can you add fish to tank 1? : $canAddFish " +
...
fun fitMoreFish(
    ...
    if (hasDecorations) {tankSize * 0.8}
    if (fishSize.toDouble() + currentFish.sum() >= tankSize * 0.8) {return false}
    if (currentFish.sum() >= tankSize * 0.8) {return false}
